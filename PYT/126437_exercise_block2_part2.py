...
class Sequence(object):
    """ Object with atrributes identifier and sequence and methods: get_identifier, get_sequence, get_mw, has_subsequence"""
    ...
    def has_subsequence(self,subsequence_obj):
        """ Return a boolean, TRUE if subsequence is present in sequence, subsequence is an instance of Sequence"""
...
class NucleotideSequence(Sequence):
    ...
    def translate(self):
        ...
        if len(sequence) % 3 != 0:
            raise ValueError("Sequence length is not multiple of 3, not possible to divide in triplets")
